...
class Poisson implements \JsonSerializable
{
    ...
    public function getImageReproduction(): ?string
    {
        return $this->image_reproduction;
    }
    public function getVideoFood(): ?string
    {
        return $this->video_food;
    }
    public function getDescriptionFood(): ?string
    {
        return $this->description_food;
    }
    public function getVideoReprod(): ?string
    {
        return $this->video_reprod;
    }
